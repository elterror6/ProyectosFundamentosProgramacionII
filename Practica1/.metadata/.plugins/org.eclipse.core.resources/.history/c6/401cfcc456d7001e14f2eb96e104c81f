...
public class Teatro{
    ...
    public void menu() {
    	...
    	while (opt != 5) {
        	...
        	System.out.println("----------------------------");
        	System.out.println("¿Cuál opción desea elegir?(1-5):");
        	opt = sc.nextInt();
        	sc.nextLine();
        	switch(opt) {
        		case 1:
        			...
        			Show[] copy = shows;
        			Suscriber[] viewers = {};
        			System.out.println("AÑADIR ESPECTACULO\n----------------------------");
