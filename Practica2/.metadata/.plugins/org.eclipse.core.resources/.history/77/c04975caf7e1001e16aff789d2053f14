...
public class Main {
	...
	public static void main(String[] args) {
		...
		alojamientos[6] = aloj;
		System.out.println("Bienvenido a nuestro buscador de alojamientos en París. Actualmente disponemos de "+ Hotel.getN() +" hoteles y "+Apartamento.getN()+" apartamentos. ¿Qué quieres consultar?");
		...
		switch (opt) {
			...
			case 4:
				...
				Alojamiento al;
				sc.nextLine();
				System.out.print("Perfecto. ¿Cómo se llama el alojamiento al que quieres ir?: ");
				name = sc.nextLine();
				System.out.print("¿Y cuál es la dirección?: ");
				address = sc.nextLine();
				...
				if (!found) {
					System.out.println("Lo sentimos. Este alojamiento no está disponible en nuestra web.");
				}
				break;
			default:
